    ...
    class BM134
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string bmyear = wsraw.Cells[14, 1].Text.ToString();
                ...
                string fullname = wsraw.Cells[prawrow, 1].Text.ToString();
                string initials = wsraw.Cells[prawrow, 8].Text.ToString();
                string eff = wsraw.Cells[prawrow, 4].Text.ToString();
                string orig = wsraw.Cells[prawrow, 6].Text.ToString();
                string dob = wsraw.Cells[prawrow, 2].Text.ToString();
                string gender = wsraw.Cells[prawrow, 5].Text.ToString();
                string premium = wsraw.Cells[prawrow, 10].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    else if (polnum != string.Empty && chck == true)
                    {
                        ...
                        dtworkRow[23] = "PHP";
                        dtworkRow[24] = "YLY";
                        dtworkRow[27] = initials;
                        dtworkRow[77] = initials;
                        dtworkRow[25] = orig;
                        dtworkRow[26] = "1.00";
                       ...
                       eff1 = oDate.Year.ToString();
                        ...
                        dtworkRow[0] = str_outfname.Substring(0, 1) + str_outlname.Substring(0, 1) + oDate.Month.ToString().PadLeft(2, '0') + oDate.Day.ToString().PadLeft(2, '0') + oDate.Year.ToString();
                    ...
                    prawrow++;
                    fullname = wsraw.Cells[prawrow, 1].Text.ToString();
                    initials = wsraw.Cells[prawrow, 8].Text.ToString();
                    eff = wsraw.Cells[prawrow, 4].Text.ToString();
                    orig = wsraw.Cells[prawrow, 6].Text.ToString();
                    dob = wsraw.Cells[prawrow, 2].Text.ToString();
                    gender = wsraw.Cells[prawrow, 5].Text.ToString();
                    premium = wsraw.Cells[prawrow, 10].Text.ToString();
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM134-" + str_savef + ".xlsx";
