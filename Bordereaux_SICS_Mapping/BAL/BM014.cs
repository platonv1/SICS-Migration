    ...
    class BM014
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string polnum = wsraw.Cells[prawrow, 6].Text.ToString();
                string cedent = wsraw.Cells[prawrow, 1].Text.ToString();
                string issue = wsraw.Cells[prawrow, 8].Text.ToString();
                string orig = wsraw.Cells[prawrow, 10].Text.ToString();
                string ceded = wsraw.Cells[prawrow, 13].Text.ToString();
                string ret = wsraw.Cells[prawrow, 12].Text.ToString();
                string dob = wsraw.Cells[prawrow, 7].Text.ToString();
                string rating = wsraw.Cells[prawrow, 5].Text.ToString();
                string age = wsraw.Cells[prawrow, 9].Text.ToString();
                ...
                while (rowcount != erawrow + 1)
                {
                    ...
                    prawrow++;
                    polnum = wsraw.Cells[prawrow, 6].Text.ToString();
                    polnum = polnum.Replace(" ", string.Empty);
                    cedent = wsraw.Cells[prawrow, 1].Text.ToString();
                    issue = wsraw.Cells[prawrow, 8].Text.ToString();
                    orig = wsraw.Cells[prawrow, 10].Text.ToString();
                    ceded = wsraw.Cells[prawrow, 13].Text.ToString();
                    ret = wsraw.Cells[prawrow, 12].Text.ToString();
                    dob = wsraw.Cells[prawrow, 7].Text.ToString();
                    rating = wsraw.Cells[prawrow, 5].Text.ToString();
                    age = wsraw.Cells[prawrow, 9].Text.ToString();
