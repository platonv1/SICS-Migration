    ...
    class BM074
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                _var.dtworkRow01 = objdt_template.NewRow();
                _var.dtworkRow01[0] = "Total Premium PHP:";
                _var.dtworkRow01[1] = dbl_BF_PHP + dbl_BH_PHP + dbl_BJ_PHP + dbl_BL_PHP;
                objdt_template.Rows.Add(_var.dtworkRow01);

                _var.dtworkRow01 = objdt_template.NewRow();
                _var.dtworkRow01[0] = "Total Premium USD:";
                _var.dtworkRow01[1] = dbl_BF_USD + dbl_BH_USD + dbl_BJ_USD + dbl_BL_USD;
                objdt_template.Rows.Add(_var.dtworkRow01);

                _var.dtworkRow01 = objdt_template.NewRow();
                _var.dtworkRow01[0] = "Total Sum at Risk PHP:";
                _var.dtworkRow01[1] = dbl_BZ_PHP;
                objdt_template.Rows.Add(_var.dtworkRow01);

                _var.dtworkRow01 = objdt_template.NewRow();
                _var.dtworkRow01[0] = "Total Sum at Risk USD:";
                _var.dtworkRow01[1] = dbl_BZ_USD;
                objdt_template.Rows.Add(_var.dtworkRow01);
                #endregion

                string despath = str_saved + @"\BM074-" + str_savef + ".xlsx";
