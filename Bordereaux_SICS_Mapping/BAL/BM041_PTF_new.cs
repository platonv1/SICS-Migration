    ...
    class BM041_PTF_new
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string issue = wsraw.Cells[prawrow, 9].Text.ToString();
                string premyr = wsraw.Cells[1][1].Text.ToString();
                ...
                string total = wsraw.Cells[prawrow2, 12].Text.ToString();
                ...
                string adjtc = wsraw.Cells[prawrow2, 12].Text.ToString();
                string adjbt = wsraw.Cells[prawrow, 13].Text.ToString();
                string adjcur = wsraw.Cells[prawrow, 14].Text.ToString();
                string adjplan = wsraw.Cells[prawrow, 2].Text.ToString();
                string adjex = wsraw.Cells[prawrow, 5].Text.ToString();
                string adjpremd = wsraw.Cells[prawrow, 6].Text.ToString();
                string adj = wsraw.Cells[prawrow, 17].Text.ToString();
                string adjc = wsraw.Cells[prawrow, 3].Text.ToString();
                string adjcurr = wsraw.Cells[prawrow, 21].Text.ToString();
                string tot = wsraw.Cells[prawrow2, 15].Text.ToString();
                string polstore;
                string bcstore;
                string ipstore;
                ...
                if ((str_sheet.Contains("JAN") || (str_sheet.Contains("FEB")) || (str_sheet.Contains("MAR"))
                    || (str_sheet.Contains("APR")) || (str_sheet.Contains("MAY")) || (str_sheet.Contains("JUN"))
                    || (str_sheet.Contains("JUL")) || (str_sheet.Contains("AUG")) || (str_sheet.Contains("SEPT"))
                    || (str_sheet.Contains("OCT")) || (str_sheet.Contains("NOV")) || (str_sheet.Contains("DEC"))) && !(str_sheet.Contains("ADJ")))
                {
                    while (rowcount != erawrow + 2)
                    {
                        ...
                        if (polnum != string.Empty && chck == false)
                        {
                            ...
                            else if (str_sheet.Contains("JAN"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("FEB"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("MAR"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("APR"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("MAY"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("JUN"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("JUL"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("AUG"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("OCT"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("SEP"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("NOV"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                            else if (str_sheet.Contains("DEC"))
                            {
                                TRANCODE = "TRENEW";
                                findboo = true;
                            }
                        ...
                        else if (chck == true)
                        {
                            ...
                            prem = wsraw.Cells[prawrow2, 13].Text.ToString();
                            age = wsraw.Cells[prawrow, 7].Text.ToString();
                            total = wsraw.Cells[prawrow2, 12].Text.ToString();
                            premyr1 = wsraw.Cells[prawrow, 12].Text.ToString();
                            tot = wsraw.Cells[prawrow2, 15].Text.ToString();
                        ...
                        issue = wsraw.Cells[prawrow, 9].Text.ToString();
                        premyr = wsraw.Cells[1][1].Text.ToString();
                        premyr1 = wsraw.Cells[prawrow, 12].Text.ToString();
                ...
                else if (str_sheet.Contains("ADJ"))
                {
                    while (rowcount != erawrow + 2)
                    {
                        ...
                        if (chck == true)
                        {
                            ...
                            dtworkRow[5] = adjplan.ToString();
                            dtworkRow[40] = adjex.ToString();
                            dtworkRow[22] = adjpremd.ToString();
                            dtworkRow[19] = adjpremd.ToString();
                            dtworkRow[20] = adjpremd.ToString();
                            if (adjcurr.ToString() == "PESO")
                            {
                                dtworkRow[23] = "PHP";
                            }
                            else
                            ...
                            cla = double.TryParse(adjtc.ToString(), out prefstore);
                            if (cla == true)
                            {
                                if (prefstore == 1)
                                {
                            ...
                            if (TRANCODE.Contains("TNEWBUS"))
                            {
                                comparestring = new string[] { "FIRST, First" };
                                dtworkRow[56] = "4000";
                                dtworkRow[57] = adj.ToString();
                            }
                            else if (TRANCODE.Contains("TRENEW"))
                            {
                                comparestring = new string[] { "RENEWAL", "RENewal" };
                                dtworkRow[58] = "4001";
                                dtworkRow[59] = adj.ToString();
                            }
                            else if ((str_sheet.Contains("ADJ")) && (TRANCODE.Contains("ADJUST") || (TRANCODE.Contains("TCANCINC")) || (TRANCODE.Contains("TEXPIRY")) ||
                                (TRANCODE.Contains("TEXTTER")) || (TRANCODE.Contains("TFULLMAT")) || (TRANCODE.Contains("TFULLPU") ||
                                (TRANCODE.Contains("TFULLREC")) || (TRANCODE.Contains("TFULLSUR") || (TRANCODE.Contains("TLAPSE") ||
                                (TRANCODE.Contains("TREINS")) || (TRANCODE.Contains("TCONTER")))))))
                            {
                            ...
                            if (adjtc.Contains("RY"))
                            {
                                dtworkRow[21] = "R&A-RY";
                            }
                            else if (adjtc.Contains("FY"))
                            {
                                dtworkRow[21] = "R&A-FY";
                            }
                            ...
                            adjcur = wsraw.Cells[prawrow, 21].Text.ToString();
                            ...
                            adjplan = wsraw.Cells[prawrow, 2].Text.ToString();
                            adjex = wsraw.Cells[prawrow, 5].Text.ToString();
                            adjpremd = wsraw.Cells[prawrow, 6].Text.ToString();
                            adj = wsraw.Cells[prawrow, 17].Text.ToString();
                            adjbt = wsraw.Cells[prawrow, 20].Text.ToString();
                        ...
                        else if ((string.IsNullOrEmpty(polnum) && (string.IsNullOrEmpty(adjplan) && !(string.IsNullOrEmpty(adjc)))))
                        {
                            dtworkRow = objdt_template.NewRow();
                        ...
                        adjs = wsraw.Cells[prawrow2, 17].Text.ToString();
                        remarks = wsraw.Cells[prawrow2, 18].Text.ToString();
                        adjtc = wsraw.Cells[prawrow2, 12].Text.ToString();
                        ...
                        adjbt = wsraw.Cells[prawrow, 20].Text.ToString();
                        adjcurr = wsraw.Cells[prawrow, 21].Text.ToString();
                        adjc = wsraw.Cells[prawrow, 3].Text.ToString();
                    }
                }
                #endregion
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM041-PTF-" + str_sheet + str_savef + ".xlsx";
