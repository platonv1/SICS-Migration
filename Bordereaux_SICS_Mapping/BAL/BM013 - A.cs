    ...
    class BM013_A
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string branded = wsraw.Cells[prawrow, 5].Text.ToString();
                string reins = wsraw.Cells[prawrow, 11].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    if (cession != string.Empty && chck == true)
                    {
                        ...
                        if (_var.dtworkRow01[21].ToString().ToUpper() == "TRENEW")
                        {
                            ...
                            _var.dtworkRow01[22] = parsedreins.Month + "/" + parsedreins.Day + "/" + byear; //trans effective
                            _var.dtworkRow01 [19] = _var.dtworkRow01 [22];
                        }
                        else
                        {
                            _var.dtworkRow01[22] = reins;//trans effective
                        }
                        ...
                        if (String.IsNullOrEmpty(_var.dtworkRow01[19].ToString()))
                        {
                            ...
                            {
                                _var.dtworkRow01[19] = _var.dtworkRow01[22]; //reinsurance
                                _var.dtworkRow01 [20] = _var.dtworkRow01 [22];
                            }
                            else
                            {
                                _var.dtworkRow01[19] = _var.dtworkRow01[20];//reinsurance
                            }
                        }
                        //ISSUE#010-End-----------
                    ...
                    branded = wsraw.Cells[prawrow, 5].Text.ToString();
                    reins = wsraw.Cells[prawrow, 11].Text.ToString();
                    Console.WriteLine(polnum + "--->" + reins);
