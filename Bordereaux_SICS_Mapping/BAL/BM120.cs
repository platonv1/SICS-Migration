    ...
    class BM120
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string eff = wsraw.Cells[prawrow, 4].Text.ToString();
                string orig = wsraw.Cells[prawrow, 15].Text.ToString();
                string ceded = wsraw.Cells[prawrow, 18].Text.ToString();
                ...
                string classific = wsraw.Cells[prawrow, 9].Text.ToString();
                string premium = wsraw.Cells[prawrow, 26].Text.ToString();
                string age= wsraw.Cells[prawrow,8].Text.ToString();
                string bmyear = wsraw.Cells[4, 1].Text.ToString();
              ...
              //  DateTime date_bmyear = Convert.ToDateTime(bmyear);
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    else if (polnum != string.Empty && chck == true)
                    {
                        ...
                        dtworkRow[13] = "IND";
                        dtworkRow[14] = "T";
                        DateTime oDate = Convert.ToDateTime(eff);
                        dtworkRow[19] = oDate.Month.ToString() + "/" + oDate.Day.ToString() + "/" + bmyear;
                        dtworkRow[22] = oDate.Month.ToString() + "/" + oDate.Day.ToString() + "/" + bmyear;
                        dtworkRow[20] = eff;
                        dtworkRow[23] = "PHP";
                        dtworkRow[25] = orig;
                        dtworkRow[26] = ceded;
                        ...
                        bmy = Convert.ToInt32(bmyear);
                        eff1 = oDate.Year.ToString();
                        bmy = Convert.ToInt32(bmyear);
                        effint = Convert.ToInt32(eff1);
                        ...
                        if (classific == ("CLASS A"))
                        {
                            dtworkRow[39] = "CLASSA";
                        }
                        else if (classific == ("CLASS AA"))
                        {
                            dtworkRow[39] = "CLASSAA";
                        }
                        else if (classific == ("CLASS B"))
                        {
                            dtworkRow[39] = "CLASSB";
                        }
                        else if (classific == ("CLASS C"))
                        {
                            dtworkRow[39] = "CLASSC";
                        }
                        else if (classific == ("CLASS D"))
                        {
                            dtworkRow[39] = "CLASSD";
                        }
                        else if (classific == ("CLASS II"))
                        {
                            dtworkRow[39] = "CLASSD";
                        }
                        else if (classific == ("CLASS E"))
                        {
                            dtworkRow[39] = "CLASSE";
                        }
                        else if (classific == ("CLASS F"))
                        {
                            dtworkRow[39] = "CLASSF";
                        }
                        else if (classific == ("CLASS G"))
                        {
                            dtworkRow[39] = "CLASSG";
                        }
                        else if (classific == ("CLASS H"))
                        {
                            dtworkRow[39] = "CLASSH";
                        }
                        else if (classific == ("CLASS III"))
                        {
                            dtworkRow[39] = "CLASSH";
                        }
                        else if (classific == ("CLASS I"))
                        {
                            dtworkRow[39] = "CLASSI";
                        }
                        else if (classific == ("CLASS J"))
                        {
                            dtworkRow[39] = "CLASSJ";
                        }
                        else if (classific == ("CLASS K"))
                        {
                            dtworkRow[39] = "CLASSK";
                        }
                        else if (classific == ("CLASS L"))
                        {
                            dtworkRow[39] = "CLASSL";
                        }
                        else if (classific == ("CLASS M"))
                        {
                            dtworkRow[39] = "CLASSM";
                        }
                        else if (classific == ("CLASS N"))
                        {
                            dtworkRow[39] = "CLASSN";
                        }
                        else if (classific == ("CLASS O"))
                        {
                            dtworkRow[39] = "CLASSO";
                        }
                        else if (classific == ("CLASS P"))
                        {
                            dtworkRow[39] = "CLASSP";
                        }
                        else if (classific == ("CLASS IV"))
                        {
                            dtworkRow[39] = "CLASSL";
                        }
                        else if (classific == ("CLASS V"))
                        {
                            dtworkRow[39] = "CLASSP";
                        }
                    ...
                    eff = wsraw.Cells[prawrow, 4].Text.ToString();
                    orig = wsraw.Cells[prawrow, 15].Text.ToString();
                    ceded = wsraw.Cells[prawrow, 18].Text.ToString();
                    ...
                    classific = wsraw.Cells[prawrow, 9].Text.ToString();
                    premium = wsraw.Cells[prawrow, 26].Text.ToString();
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM120-" + str_savef + ".xlsx";
