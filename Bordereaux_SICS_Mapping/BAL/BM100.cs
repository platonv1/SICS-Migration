    ...
    class BM100
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string premium = wsraw.Cells[prawrow, 8].Text.ToString();
                string age = wsraw.Cells[prawrow, 6].Text.ToString();
                string poldate = wsraw.Cells[prawrow, 5].Text.ToString();
                string currency = wsraw.Cells[5, 4].Text.ToString();
                currency = currency.Substring(currency.Length - 9, 2);
                string year = wsraw.Cells[5, 16].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    else if (polnum != string.Empty && chck == true)
                    {
                        ...
                        string poldate1;
                        int pold1;
                        year1 = year.Substring(year.Length - 4, 4);
                        bmyear1 = Convert.ToInt32(year1);

                        DateTime oDate = Convert.ToDateTime(poldate);
                        poldate1 = oDate.Year.ToString();
                        pold1 = Convert.ToInt32(poldate1);
                    ...
                    premium = wsraw.Cells[prawrow, 8].Text.ToString();
                    age = wsraw.Cells[prawrow, 6].Text.ToString();
                    poldate = wsraw.Cells[prawrow, 5].Text.ToString();
                    gender = string.Empty;
                    rowcount++;
                }
                #endregion
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM100-" + str_savef + ".xlsx";
