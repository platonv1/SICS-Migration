    ...
    class BM101
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string cert = wsraw.Cells[prawrow, 5].Text.ToString();
                ...
                string premium = wsraw.Cells[prawrow, 19].Text.ToString();
                string age = wsraw.Cells[prawrow, 10].Text.ToString();
                string holder = wsraw.Cells[prawrow, 3].Text.ToString();
                string currency = wsraw.Cells[prawrow, 11].Text.ToString();
             ...
             //   string currency = string.Empty;
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    else if (polnum != string.Empty && chck == true)
                    {
                       ...
                       // dtworkRow[5] = code;
                        ...
                        //if (dob.Length == 9) && 
                        //{
                        //    dob = dob.Substring(dob.Length - 4, 2) + "/" + dob.Substring(dob.Length - 2, 2) + "/" + dob.Substring(dob.Length - 9, 4);

                        //}
                        //if (dob.Length == 10)
                        //{
                        //    dob = dob.Substring(dob.Length - 4, 2) + "/" + dob.Substring(dob.Length - 2, 2) + "/" + dob.Substring(dob.Length - 10, 4);

                        //}
                        //if (dob.Length == 8)
                        //{
                        //    dob = dob.Substring(dob.Length - 4, 2) + "/" + dob.Substring(dob.Length - 2, 2) + "/" + dob.Substring(dob.Length - 8, 4);
                        ...
                        dtworkRow[0] = polnum + str_outfname.Substring(0, 1) + str_outlname.Substring(0, 1) + oDate.Month.ToString().PadLeft(2, '0') + oDate.Day.ToString().PadLeft(2, '0') + oDate.Year.ToString();
                    ...
                    prawrow++;
                    cert = wsraw.Cells[prawrow, 5].Text.ToString();
                    ...
                    premium = wsraw.Cells[prawrow, 19].Text.ToString();
                    age = wsraw.Cells[prawrow, 10].Text.ToString();
                    holder = wsraw.Cells[prawrow, 3].Text.ToString();
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM101-" + str_savef + ".xlsx";
