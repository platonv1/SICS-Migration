    ...
    class BM038
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string life = wsraw.Cells[prawrow, 7].Text.ToString();
                string life1 = wsraw.Cells[prawrow, 8].Text.ToString();
                string life2 = wsraw.Cells[prawrow, 9].Text.ToString();
                ...
                string prem1 = wsraw.Cells[prawrow, 16].Text.ToString();
                string prem2 = wsraw.Cells[prawrow, 17].Text.ToString();
                string prem3 = wsraw.Cells[prawrow, 18].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                   life = life.TrimStart(' ').TrimEnd(' ').Replace(",", String.Empty);
                    ...
                    chck = int.TryParse(life, out storee);
                    life = objHlpr.fn_stringcleanup(life);


                    if (life == string.Empty && chck == false)
                    {
                        findboo = false;
 
                    }
                    else if (life != string.Empty && chck == true)
                    {
                        ...
                        fullname = fullname.TrimStart(' ').TrimEnd(' ').Replace(",", " , ");
                        ...
                        string polnum = "CORPORATION" + str_outfname.Substring(0, 1) + str_outlname.Substring(0, 1) + oDate.Month.ToString().PadLeft(2, '0') + oDate.Day.ToString().PadLeft(2, '0') + oDate.Year.ToString();
                        dtworkRow[0] = polnum;
                        ...
                        if ((life != String.Empty) && (life1 != String.Empty) && (life2 == String.Empty))
                        {
                            dtworkRow01.ItemArray = dtworkRow.ItemArray;
                            dtworkRow01[5] = "AD&D";
                            dtworkRow01[25] = life1;
                            dtworkRow01[27] = ini1;
                        }
                        else if ((life != String.Empty) && (life1 == String.Empty) && (life2 != String.Empty))
                        {
                            dtworkRow01.ItemArray = dtworkRow.ItemArray;
                            dtworkRow01[5] = "TPD";
                            dtworkRow01[25] = life2;
                            dtworkRow01[27] = ini2;
                        }
                        else if ((life != String.Empty) && (life1 != String.Empty) && (life2 != String.Empty))
                        {
                    ...
                    life = wsraw.Cells[prawrow, 7].Text.ToString();
                    life1 = wsraw.Cells[prawrow, 8].Text.ToString();
                    life2 = wsraw.Cells[prawrow, 9].Text.ToString();
                    ...
                    prem1 = wsraw.Cells[prawrow, 16].Text.ToString();
                    prem2 = wsraw.Cells[prawrow, 17].Text.ToString();
                    prem3 = wsraw.Cells[prawrow, 18].Text.ToString();
                    rowcount++;
                }
                #endregion
                ...
                string despath = str_saved + @"\BM038-" + str_savef + ".xlsx";
