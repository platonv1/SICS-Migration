    ...
    class BM016
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string amount = wsraw.Cells[prawrow, 5].Text.ToString();
                string prem = wsraw.Cells[prawrow, 6].Text.ToString();
                string rprem = wsraw.Cells[prawrow, 7].Text.ToString();
                ...
                while (rowcount != erawrow + 2) //loop
                {
                    ...
                    amount = wsraw.Cells[prawrow, 5].Text.ToString();
                    prem = wsraw.Cells[prawrow, 6].Text.ToString();
                    rprem = wsraw.Cells[prawrow, 7].Text.ToString();
