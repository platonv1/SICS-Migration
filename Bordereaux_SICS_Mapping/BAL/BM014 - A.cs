    ...
    class BM014_A
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string polnum = wsraw.Cells[prawrow, 11].Text.ToString();
                string cedent = wsraw.Cells[prawrow, 1].Text.ToString();
                string issue = wsraw.Cells[prawrow, 13].Text.ToString();
                string orig = wsraw.Cells[prawrow, 15].Text.ToString();
                string ceded = wsraw.Cells[prawrow, 18].Text.ToString();
                string ret = wsraw.Cells[prawrow, 17].Text.ToString();
                string dob = wsraw.Cells[prawrow, 12].Text.ToString();
                string rating = wsraw.Cells[prawrow, 7].Text.ToString();
                string age = wsraw.Cells[prawrow, 14].Text.ToString();
                ...
                string fullbyear = arr_fullbyear[arr_fullbyear.Length - 2] + " " + arr_fullbyear[arr_fullbyear.Length - 4] + " " + arr_fullbyear[arr_fullbyear.Length - 1];
                ...
                while (rowcount != erawrow + 1)
                {
                    ...
                    if (cedent != string.Empty && chck == true)
                    {
                        ...
                        //_var.dtworkRow01[19] = issue;
                        _var.dtworkRow01[20] = issue;
                        _var.dtworkRow01[22] = issue;
                        ...
                        _var.dtworkRow01[28] = double.Parse(objHlpr.fn_dashtozero(ret));
                        ...
                        else if (str_sheet.ToUpper() == ("ADJ FIRST YEAR"))
                        {
                        ...
                        else if (str_sheet.ToUpper().Contains("ADJ RENEWAL"))
                        {
                            _var.dtworkRow01[21] = "ADJUST";
                        ...
                        {
                            DateTime parsedreins = Convert.ToDateTime(issue);
                    ...
                    prawrow++;
                    polnum = wsraw.Cells[prawrow, 11].Text.ToString();
                    polnum = polnum.Replace(" ", string.Empty);
                    cedent = wsraw.Cells[prawrow, 1].Text.ToString();
                    issue = wsraw.Cells[prawrow, 13].Text.ToString();
                    orig = wsraw.Cells[prawrow, 15].Text.ToString();
                    ceded = wsraw.Cells[prawrow, 18].Text.ToString();
                    ret = wsraw.Cells[prawrow, 17].Text.ToString();
                    dob = wsraw.Cells[prawrow, 12].Text.ToString();
                    rating = wsraw.Cells[prawrow, 7].Text.ToString();
                    age = wsraw.Cells[prawrow, 14].Text.ToString();
                    ...
                    if ((!String.IsNullOrEmpty(issue)) && (issue.Length >= 4))
                    {
                        issue = issue.Trim();
                        iyear = issue.Substring(issue.Length - 4, 4);
                    }
                ...
                string despath = str_saved + @"\BM014-" + str_savef + ".xlsx";
