    ...
    class BM015_A
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string pref = wsraw.Cells[prawrow, 7].Text.ToString();
                string polnum = wsraw.Cells[prawrow, 9].Text.ToString();
                string cert = wsraw.Cells[prawrow, 9].Text.ToString();
                string dob = wsraw.Cells[prawrow, 10].Text.ToString();
                string poldate = wsraw.Cells[prawrow, 11].Text.ToString();
                string age = wsraw.Cells[prawrow, 12].Text.ToString();
                string retention = wsraw.Cells[prawrow, 14].Text.ToString();
                string reins = wsraw.Cells[prawrow, 15].Text.ToString();
                string premium= wsraw.Cells[prawrow, 17].Text.ToString();

                string rider = wsraw.Cells[prawrow, 8].Text.ToString();
                string rprem = wsraw.Cells[prawrow, 18].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    pref = wsraw.Cells[prawrow, 7].Text.ToString();
                    polnum = wsraw.Cells[prawrow, 9].Text.ToString();
                    cert = wsraw.Cells[prawrow, 9].Text.ToString();
                    dob = wsraw.Cells[prawrow, 10].Text.ToString();
                    poldate = wsraw.Cells[prawrow, 11].Text.ToString();
                    age = wsraw.Cells[prawrow, 12].Text.ToString();
                    retention = wsraw.Cells[prawrow, 14].Text.ToString();
                    reins = wsraw.Cells[prawrow, 15].Text.ToString();
                    premium = wsraw.Cells[prawrow, 17].Text.ToString();

                    rider = wsraw.Cells[prawrow, 8].Text.ToString();
                    rprem = wsraw.Cells[prawrow, 18].Text.ToString();
