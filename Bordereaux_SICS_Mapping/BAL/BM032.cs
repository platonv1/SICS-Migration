...
namespace Bordereaux_SICS_Mapping.BAL
{
    class BM032
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false, string str_macro = "")
        {
            ...
            double dbl_premiumrate = 0.6;
            double dbl_otherrate1 = 0.9;
            double dbl_otherrate2 = 0.6;
            double dbl_AARrate = 0.6;
            ...
            try
            {
                ...
                {
                    string str_PolNum = wsraw.Cells[intLoop, 1].Text.ToString();
                    ...
                    string str_LifeReinsured = wsraw.Cells[intLoop, 10].Text.ToString(); //27
                    string str_AAR = wsraw.Cells[intLoop, 11].Text.ToString(); //76
                    ...
                    {
                        dbl_AAR = dbl_AAR * (boo_isFacul || boo_isSpecial ? 1 : dbl_AARrate);
                    }
                    else
                    {
                        dbl_AAR = 1;
                    ...
                    string str_PremiumSAR = wsraw.Cells[intLoop, 8].Text.ToString();

                    if (double.TryParse(objHlpr.fn_numbercleanup_negative(str_PremiumLife), out double dbl_PremiumLife))
                    {
                        dbl_PremiumLife = dbl_PremiumLife * (boo_isFacul || boo_isSpecial ? 1 : dbl_premiumrate);
                    }
                    else
                    {
                        dbl_PremiumLife = 0;
                    ...
                    if (double.TryParse(objHlpr.fn_numbercleanup_negative(str_PremiumExtra), out double dbl_PremiumExtra))
                    {
                         ...
                         dbl_PremiumExtra = (dbl_PremiumExtra * dbl_otherrate1) * (boo_isFacul || boo_isSpecial ? 1 : dbl_otherrate2);
                    ...
                    if (double.TryParse(objHlpr.fn_numbercleanup_negative(str_PremiumADB), out double dbl_PremiumADB))
                    {
                        ...
                        dbl_PremiumADB = (dbl_PremiumADB * dbl_otherrate1) * (boo_isFacul || boo_isSpecial ? 1 : dbl_otherrate2);
                    ...
                    if (double.TryParse(objHlpr.fn_numbercleanup_negative(str_PremiumSAR), out double dbl_PremiumSAR))
                    {
                        ...
                        dbl_PremiumSAR = (dbl_PremiumSAR * dbl_otherrate1) * (boo_isFacul || boo_isSpecial ? 1 : dbl_otherrate2);
                    ...
                    if (!String.IsNullOrEmpty(str_PremiumSAR) && str_PremiumSAR.Trim() != "-")
                    {
                        ...
                        _var.dtworkRow04[5] = str_code;
                        _var.dtworkRow04[6] = "BP290";

                        _var.dtworkRow04[25] = dbl_SAR_SARDIOSA;
                        _var.dtworkRow04[27] = dbl_SAR_SARDIReinsured;
                        _var.dtworkRow04[77] = 1;
                        _var.dtworkRow04[28] = dbl_SAR_SARDIret;

                        if (str_tcode == "TRENEW")
                        {
                            _var.dtworkRow04[59] = dbl_PremiumSAR;
                        }
                        else
                        {
                            if ((dt_PremiumDate - dt_IssueDate).TotalDays <= 365)
                            {
                                _var.dtworkRow04[61] = dbl_PremiumSAR;
                            }
                            else
                            {
                                _var.dtworkRow04[63] = dbl_PremiumSAR;
                            }
                        }
                    }
                ...
                string despath = str_saved + @"\BM032-" + str_savef + ".xlsx";
