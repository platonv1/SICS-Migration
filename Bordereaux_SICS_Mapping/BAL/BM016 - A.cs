    ...
    class BM016_A
    {
        public string fn_process(string str_raw, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                string reins = wsraw.Cells[prawrow, 5].Text.ToString();
                string amount = wsraw.Cells[prawrow, 6].Text.ToString();
                string prem = wsraw.Cells[prawrow, 7].Text.ToString();
                string rprem = wsraw.Cells[prawrow, 8].Text.ToString();
                ...
                while (rowcount != erawrow + 2) //loop
                {
                    ...
                    reins = wsraw.Cells[prawrow, 5].Text.ToString();
                    amount = wsraw.Cells[prawrow, 6].Text.ToString();
                    prem = wsraw.Cells[prawrow, 7].Text.ToString();
                    rprem = wsraw.Cells[prawrow, 8].Text.ToString();
