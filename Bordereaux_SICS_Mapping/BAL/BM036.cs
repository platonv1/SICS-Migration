    ...
    class BM036
    {
        public string fn_process(string str_raw, string str_sicstemp, string str_sheet, string str_saved, string str_savef, string str_gender = "", bool boo_open = false, bool boo_clean = false)
        {
            ...
            try
            {
                ...
                int prawrow = 1;
                string polnum = wsraw.Cells[prawrow, 5].Text.ToString();
                string plan = wsraw.Cells[prawrow, 6].Text.ToString();
                string poldate = wsraw.Cells[prawrow, 10].Text.ToString();
                string currency = wsraw.Cells[prawrow, 7].Text.ToString();
                string orig = wsraw.Cells[prawrow, 15].Text.ToString();
                string fullname= wsraw.Cells[prawrow, 4].Text.ToString();
                string gender= wsraw.Cells[prawrow,9].Text.ToString();
                string dob = wsraw.Cells[prawrow, 8].Text.ToString();
                string expiry = wsraw.Cells[prawrow, 11].Text.ToString();
                string initial= wsraw.Cells[prawrow, 14].Text.ToString();
                string TRANCODE = wsraw.Cells[prawrow, 29].Text.ToString();
                ...
                while (rowcount != erawrow + 2)
                {
                    ...
                    else if (polnum != string.Empty && chck == true)
                    {
                        ...
                        dtworkRow[25] = orig;
                        dtworkRow[27] = initial;
                        dtworkRow[28] = initial;
                        dtworkRow[77] = initial;
                    ...
                    prawrow++;
                    polnum = wsraw.Cells[prawrow, 5].Text.ToString();
                    plan = wsraw.Cells[prawrow, 6].Text.ToString();
                    poldate = wsraw.Cells[prawrow, 10].Text.ToString();
                    currency = wsraw.Cells[prawrow, 7].Text.ToString();
                    orig = wsraw.Cells[prawrow, 15].Text.ToString();
                    fullname = wsraw.Cells[prawrow, 4].Text.ToString();
                    gender = wsraw.Cells[prawrow, 9].Text.ToString();
                    dob = wsraw.Cells[prawrow, 8].Text.ToString();
                   expiry = wsraw.Cells[prawrow, 11].Text.ToString();
                    initial = wsraw.Cells[prawrow, 14].Text.ToString();
                     TRANCODE = wsraw.Cells[prawrow, 29].Text.ToString();
                ...
                objdt_template.Rows.Add(dtworkRow);
                #endregion
                string despath = str_saved + @"\BM036-" + str_savef + ".xlsx";
